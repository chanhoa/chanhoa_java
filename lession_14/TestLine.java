...
public class TestLine {
    public static void main(String[] args) {
        ...
        System.out.println("end's is:" + l1.getEndX());
        System.out.println("end's is:" + l1.getEndY());

        l1.setBeginXY(31,32);
        l1.setEndXY(33,34);
        System.out.println(l1);
        System.out.println("begin's x and y are:" + Arrays.toString(l1.getBegintXY()));
